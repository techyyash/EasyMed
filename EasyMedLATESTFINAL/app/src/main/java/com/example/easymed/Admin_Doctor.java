...
public class Admin_Doctor extends AppCompatActivity {
 ...
 /*   GoogleSignInClient mGoogleSignInClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler = new databasehelper2(Admin_Doctor.this);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (docname.isEmpty() && docmob.isEmpty() && docmail.isEmpty() && docedu.isEmpty()&& docdes.isEmpty()&& docdes.isEmpty()&&docspec.isEmpty()) {
                    Toast.makeText(Admin_Doctor.this, "Please enter all the data..", Toast.LENGTH_SHORT).show();
                    return;
                }
...
*/
                ...
                Toast.makeText(Admin_Doctor.this, "Data Entered", Toast.LENGTH_SHORT).show();
...
*/
                ...
                */
                ...
                if (loginusername.equals("") || loginpassword.equals("")) {
                        ...
                        Toast.makeText(Admin_Doctor.this, "PLEASE ENTER ALL THE FIELDS!", Toast.LENGTH_LONG).show();
                        Toast.makeText(Admin_Doctor.this, "PLEASE ENTER ALL THE FIELDS!", Toast.LENGTH_LONG).show();
                    ...
                    if (checkuserpass == true) {
                        Toast.makeText(Admin_Doctor.this, "LOGGING IN", Toast.LENGTH_SHORT).show();
                        Intent activity2Intent = new Intent(getApplicationContext(), hospital_home.class);
                        // temp=loginusername;
                        startActivity(activity2Intent);
                    } else if (checkuserpass == false) {
                        Toast.makeText(Admin_Doctor.this, "Wrong Credentials! TRY AGAIN", Toast.LENGTH_SHORT).show();
                    }
